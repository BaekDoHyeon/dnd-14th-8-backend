...
- **ODsay 대중교통 API**: 출발지 → 추천 역 대중교통 경로
...
└── global
    ├── client
    │   ├── google     # Google Distance Matrix / Places
